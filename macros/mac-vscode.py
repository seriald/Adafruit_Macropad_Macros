...
from adafruit_hid.keycode import Keycode # REQUIRED if using Keycode.* 
values
...
app = {                      # REQUIRED dict, must be named 'app'
    ...
    'macros' : [             # List of button macros...
        ...
        # 1st row ----------
        (0x6a0dad, 'Pref', [Keycode.SHIFT, Keycode.COMMAND, 'p']), # 
command palette
        (0x6a0dad, 'Open', [Keycode.COMMAND, 'o']), # open file
        (0x6a0dad, 'Settings', [Keycode.COMMAND, ',']), # open user 
settings
        # 2nd row ----------
        ...
        (0xFFA500, 'Comment', [Keycode.COMMAND, '/']), # toggle line 
comment on/off
        (0xFFA500, 'Format', [Keycode.SHIFT, Keycode.ALT, 'f']), # format 
code
        # 4th row ----------
        (0xb20000, 'Find All', [Keycode.SHIFT, Keycode.COMMAND, 'f']), # 
find in all docs
        (0xb20000, 'Find', [Keycode.COMMAND, 'f']), # find in doc
        (0xb20000, 'Terminal', [Keycode.SHIFT, Keycode.CONTROL, '`']), # 
open terminal
        # Encoder button ---
