...
key_enter]}
split_horizontally = {"label": "hsplit", "keys": [41, ":", "split", 
key_enter]}

# Windows:Navigate
move_to_top_window = {"label": "up", "keys": [41, key_control, "w", "k"]}
move_to_right_window = {"label": "right", "keys": [41, key_control, "w", 
"l"]}
move_to_bottom_window = {"label": "down", "keys": [41, key_control, "w", 
"j"]}
move_to_left_window = {"label": "left", "keys": [41, key_control, "w", 
"h"]}

# Windows:Sizing
maximize_window_vertically = {"label": "max v", "keys": [41, key_control, 
"w", "_"]}
maximize_window_horizontally = {"label": "max h", "keys": [41, 
key_control, "w", "|"]}
...
open_files_in_tabs = {"label": "f2t", "keys": [41, ":", "tab ball", 
key_enter]}

# Files
open_telescope = {"label": "files", "keys": [49, "f", "f"]}
vsplit_integrated_file_explorer = {"label": "files", "keys":  [":", 
"Sex!", key_enter]}
...
app = {
    ...
    "macros": [
        ...
        (teal, maximize_window_vertically["label"], 
maximize_window_vertically["keys"]),
        (teal, maximize_window_horizontally["label"], 
maximize_window_horizontally["keys"]),
        # 3rd row ----------
        (yellow, write_close["label"], write_close["keys"]),
        (hot_pink, move_to_top_window["label"], 
move_to_top_window["keys"]),
        (hot_pink, move_to_right_window["label"], 
move_to_right_window["keys"]),
        # 4th row ----------
        (purple, open_telescope["label"], open_telescope["keys"]),  # 
Telescope
        (hot_pink, move_to_bottom_window["label"], 
move_to_bottom_window["keys"]),
        (hot_pink, move_to_left_window["label"], 
move_to_left_window["keys"]),
        # Encoder ----------
